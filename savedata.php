...
function saveLeadData($db, $data) {
    $commonFields = ["source_url","client_id","project_id","ip_address" ,"name","email", "ph_number", "status", "is_send_discord","is_verified"];
